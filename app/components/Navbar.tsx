            ...
            <div className="flex h-16 justify-between">
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <Link to={"blogs/admin/new"}>
                    <button
                      type="button"
                      className="relative inline-flex items-center rounded-md border border-transparent bg-blue-500 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                    >
                      <PlusIcon
